export const en = {
  ...
  authFiles: {
    ...
    toasts: {
      ...
      batchDownloadErrors: "{{count}} file(s) failed to download",
      batchDownloadSucceeded: "{{count}} auth file(s) downloaded successfully",
  ...
  dashboard: {
    ...
    quota: {
      ...
      confirmResetQuota: "Click again to reset ChatGPT quota",
      ...
      hideHiddenAccounts: "Hide hidden accounts",
      ...
      resetQuota: "Reset ChatGPT quota",
      resetQuotaWithCount: "Reset ChatGPT quota ({{count}} left)",
      refresh: "Refresh quota",
      resetsIn: "Resets in {{time}}",
      sevenDayWeekly: "7-Day Weekly",
      showAccount: "Show account",
      showHiddenAccounts: "Show hidden ({{count}})",
      unknown: "Unknown",
      unlimited: "Unlimited",
